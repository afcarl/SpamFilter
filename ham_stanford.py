...
for file_name in all_files:
    ...
    PATH_TO_STANFORD_JAR = "../stanford-corenlp/jar/stanford-corenlp-3.5.2.jar"
    os.system("java -cp " + PATH_TO_STANFORD_JAR + " edu.stanford.nlp.process.PTBTokenizer " + \
...
with open('./HAM/all_mails.pickle', 'wb') as mails:
    pickle.dump(all_mails, mails)

# need this ?
with open('./HAM/unparsed.pickle', 'wb') as unp:
